...
public class MirGame extends JavaPlugin{
	...
	public void box() {
		...
		boxs.add(new CollectBox("§l(구)슬롯 보상", new ItemStack[]{gc.getBean(35),gc.getEye(2), gc.getTool(5), gc.getCoin(10)})); //(구)슬롯 보상
		//슬롯 보상
		boxs.add(new CollectBox("§r슬롯 보상 <철 3개>", new ItemStack[]{gc.getBean(5)}));
		boxs.add(new RandomBox("§r슬롯 보상 <철 4개>",new ItemStack[]{gc.getCoin(10), gc.getBean(10), gc.getEye(1)}));
		boxs.add(new RandomBox("§r슬롯 보상 <금 3개>",new ItemStack[]{gc.getBean(10), gc.getEye(1)}));
		boxs.add(new RandomBox("§l슬롯 보상 <금 4개>",new ItemStack[]{gc.getCoin(15), gc.getBean(20), gc.getEye(2), new ItemStack(Material.TOTEM,1)}));
		boxs.add(new RandomBox("§r슬롯 보상 <다이아몬드 3개>",new ItemStack[]{gc.getBean(15), gc.getEye(2), gc.getCoin(10)}));
		boxs.add(new RandomBox("§l슬롯 보상 <다이아몬드 4개>",new ItemStack[]{gc.getCoin(20), gc.getBean(20), gc.getEye(2), new ItemStack(Material.TOTEM,2)}));
		boxs.add(new RandomBox("§r슬롯 보상 <에메랄드 3개>",new ItemStack[]{gc.getBean(25), gc.getEye(3), gc.getCoin(20)}));
		boxs.add(new SelectBox("§l슬롯 보상 <에메랄드 4개>",new ItemStack[]{mr.gr.MendingBook(1), gc.getBean(30), gc.getEye(3), new ItemStack(Material.TOTEM,3), new ItemStack(Material.BEACON, 1)}));
		boxs.add(new RandomBox("§l슬롯 보상 <네더의 별 3개>",new ItemStack[]{gc.getCoin(20), gc.getEye(3), gc.getBean(30), new ItemStack(Material.BEACON,1)}));
		boxs.add(new CollectBox("§a§l슬롯 보상 <네더의 별 4개>",new ItemStack[]{mr.gr.MendingBook(1), gc.getEye(10), gc.getBean(5), new ItemStack(Material.BEACON,1), new ItemStack(Material.TOTEM,5)}));
		//슬라이딩 보상
